			...
			<div class="card bg-light mb-3">
				...
				<ul class="list-group category_block">
					...
					<c:forEach items="${categorylist}" var="c">
						<li class="list-group-item"><a
							href="selectbycat?catid=${c.categoryid}">${c.categoryname}</a></li>
					</c:forEach>
				</ul>
			</div>
					...
					<div class="col-4">
						...
						<div class="card">
							<img class="card-img-top"
								src="resources/productimages/${viewallprod.productid}.jpg"
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<a href="viewoneproduct?proid=${viewallprod.productid}"
