			...
			<div class="col-md-3 Services-tab  item">
				<div class="folded-corner service_tab_1">
					<div class="text">
						...
						<!-- /.item-title -->
						<p>To create a Greener World & Contribute a bit against Global
							Warming.To create spaces around us green & healthy " To achieve
							this we aim to open 100+ green stores in every city of India &
							help promote people gift plant - gift life.</p>
					</div>
				</div>
			</div>
			<div class="col-md-3 Services-tab item">
