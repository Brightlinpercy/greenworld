				...
				<tbody>
					<c:forEach items="${productlist}" var="prod">
						<tr>
							...
							<td><img src="${cr}/admin/resources/productimages/${prod.productid}.jpg" height="75" width="75"/></td>
							
							<td><a class='btn btn-info btn-xs'
								href="${cr}/admin/editproduct?productid=${prod.productid}"><span
									class="glyphicon glyphicon-edit"></span> Edit</a> <a
								href="${cr}/admin/deleteproduct?productid=${prod.productid}"
